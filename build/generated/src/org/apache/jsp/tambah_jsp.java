...
public final class tambah_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Tambah Data</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <h1>Tambah Data</h1>\n");
      out.write("         \n");
      out.write("        ");
     String npm=request.getParameter("npm");     
        ...
        String sql="insert into mahasiswa (npm, nama, alamat, prodi, semester) values "+ "('"+npm+"','"+nama+"','"+alamat+"','"+prodi+"','"+semester+"')";         
